...
<p className="text__para">search for doctors and book appointments independently</p>
...
<div className="flex items-center justify-center"><img src={icon01} alt=""></img>
  </div>
  <div className="mt-[30px]">
...
<div className="py-[30px] px-5 ">
<div className="flex items-center justify-center"><img src={icon02} alt=""></img>
  </div>
  <div className="mt-[30px]">
...
<div className="py-[30px] px-5 ">
<div className="flex items-center justify-center"><img src={icon003} alt=""></img>
  </div>
  <div className="mt-[30px]">
...
<section>
  <div className="container">
    <div className="xl:w-[470px] mx-auto">
      ...
      <p className="text__para text-center">
        World-class care for everyone. Our health System offers health care</p>
    </div>
  </div>
  <Testimonial/>
</section>
